        ...
        >
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-medium leading-tight lg:leading-20 max-w-5xl">
            <span className="text-gray-900">
              The design dream team for founders obsessed with shipping fast.{' '}
            </span>
          ...
          >
            ...
            <div className="space-y-6">
              <h3 className="text-lg font-medium text-gray-900">
                Over 18 years grinding alongside founders with a chip on their shoulder and a story that needs telling.
              </h3>
              
              <p className="text-lg text-gray-600 leading-relaxed">
                Synrgy is the design partner teams turn to when speed and quality matter most. Our approach is fast and flexible - purpose built for startup speed.
              </p>
            </div>
            ...
            <div className="pt-8">
              <p className="text-gray-400 text-lg mb-4">
                ...
                <span className="text-gray-900 font-medium">LKR 80,000&nbsp;.00</span>
              </p>
